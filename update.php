...
if (isset($_POST["submit"])) {
    ...
    $sql = "UPDATE final SET firstname='$user_name', lastname= '$user_surname', telephone= '$user_phone', email= '$user_email', category='$user_category' WHERE id=$id";

    $result = mysqli_query($conn, $sql);


    if ($result) {
        header("Location:/Lasttry/formC.html");
    } else {
